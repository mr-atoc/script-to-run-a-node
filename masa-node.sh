...
# Now download provided .ovpn file to server's $HOME dir (skip this step if you dont have .opvn yet)

# Start openvpn (skip this step if you dont have .opvn yet)
MY_CONFIGURATION_FILE="$HOME/masa-testnet-dev-client-community.ovpn"
